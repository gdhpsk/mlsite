...
// ENDS AT LINE 114
  return (
    <div className={`rounded-box flex ${legacy ? "w-full rounded-2xl" : width < 1500 ? "items-center justify-center w-full overflow-y-auto" : "w-[55%] pl-4 overflow-y-auto"} flex-col bg-[#f1f9f5] shadow-inner`}  style={{width: width < 1500 && !legacy ? "min(800px, 100%)" : "revert-layer",  height: legacy ? "100%" : "calc(100vh - 72px)"}}>
      {level ? (<>
        {legacy ? <div className='w-full h-full flex'>
          <div className={`grid ${width < 1500 && !legacy ? "justify-items-center" : "justify-items-start ml-16 h-96"} gap-y-16 ${width < 1500 ? "w-full" : "pt-12 w-2/4"} pb-12`}>

          <div className={`grid place-items-start w-full ${legacy ? "-ml-4 -mt-4" : width < 1500 ? "pl-8 pt-8" : ""} -mb-8`}>
          <Button className={`-mb-8 ${legacy ? "fixed -ml-8 -mt-6" : ""}`} onClick={() => {
                swalClose()
                selectedState("")
                setLevel(undefined)
          ...
          <ScrollAreaNoScroll className='w-2/4 h-full'>
          ...
          {!hrr ? <TabsList className="grid w-full grid-cols-3 -mb-9">
            ...
            <div className={`grid ${width < 1500 ? "place-items-center" : "place-items-start"} bg-[#dbfeea] mt-12 mb-8`} style={{width: `min(${window.innerWidth < 1500 ? "90%" : "100%"}, 400px)`}}>
          ...
          <div className={`grid ${width < 1500 ? "place-items-center" : "place-items-start"} bg-[#dbfeea] -mt-12`} style={{width: `min(${window.innerWidth < 1500 ? "90%" : "calc(100% - 160px), 90%"}, 400px)`, marginTop: hrr ? "-128px" : "unset"}}>
            ...
            {level.position <= 50 ? <div className={`grid ${width < 1500 ? "place-items-center" : "place-items-start"} bg-[#dbfeea] -mt-12`} style={{width: `min(${window.innerWidth < 1500 ? "90%" : "calc(100% - 160px), 90%"}, 400px)`, marginTop: hrr ? "-128px" : "unset"}}>
